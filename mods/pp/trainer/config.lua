...
return {
	...
	DLCUnlocker = true, --Unlocks all dlcs in game. Use with caution, OVERKILL implemented check, if you wearing DLC item or creating DLC heist from DLC you don't own.
	...
	Crosshair = false, --Enable crosshair on all weapons
